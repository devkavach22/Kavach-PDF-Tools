        ...
        <main className="flex-1 flex-col py-16">
          <div className="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center space-y-3">
              ...
              <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-red-500 to-amber-500">Word to PDF</h1>
              <p className="text-lg text-slate-400">Convert your Word document (.docx, .doc) to a universal PDF file</p>
            </div>

             <Card className="bg-slate-900/40 backdrop-blur-md shadow-xl border border-white/10 max-w-3xl mx-auto mt-8">
                <CardHeader>
                  <CardTitle className="text-white">Upload Word File</CardTitle>
                  <CardDescription className="text-slate-400">Select a Word file to convert</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  {file && (
                    <div className="flex items-center justify-between p-4 rounded-xl border bg-slate-800/60 border-orange-500/20 text-white">
                        <div className="flex items-center gap-3"><FileText className="h-5 w-5 text-orange-400" /><span className="font-medium">{file.name}</span></div>
