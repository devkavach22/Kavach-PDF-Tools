            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4">
              <div className="lg:col-span-2">
                <Card className="bg-white shadow-xl border border-slate-200 h-full">
                  <CardHeader>
                    <CardTitle className="text-slate-900">{!file ? "Upload PDF File" : "Selected File"}</CardTitle>
                    {!file && <CardDescription className="text-slate-500">Select the PDF file you want to rotate</CardDescription>}
                  </CardHeader>
                  <CardContent>
                    {!file ? (
                      ...
                      <div className="p-4 rounded-xl border bg-slate-50 border-orange-200 flex items-center justify-between">
              ...
              <div className="lg:col-span-1 space-y-4">
                <Card className="bg-white shadow-xl border border-slate-200">
                  <CardHeader>
                    <div className="flex justify-between items-center">
                      ...
                      <Button variant="link" className="p-0 text-sm text-orange-600" onClick={() => setFile(null)} disabled={!file}>Reset</Button>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <RadioGroup value={rotation} onValueChange={setRotation} className="flex flex-col gap-3" disabled={!file}>
                      <Label htmlFor="right" className="flex items-center space-x-3 p-3 border border-slate-200 rounded-xl hover:border-orange-500/50 bg-slate-50 cursor-pointer data-[state=checked]:border-orange-500 transition-all">
                      ...
                      <Label htmlFor="left" className="flex items-center space-x-3 p-3 border border-slate-200 rounded-xl hover:border-orange-500/50 bg-slate-50 cursor-pointer data-[state=checked]:border-orange-500 transition-all">
                ...
                <Button onClick={handleRotate} disabled={!file} className="w-full bg-orange-600 hover:bg-orange-700 text-white text-base py-6 rounded-xl font-semibold shadow-lg shadow-orange-500/20">
