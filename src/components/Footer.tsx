...
import { Facebook, Twitter, Linkedin, Github, Heart, Shield } from "lucide-react";
...
export const Footer = () => {
  ...
  return (
    // Theme Update: Changed bg to slate-900 (#0f172a) to match Landing
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="md:col-span-2 space-y-6">
                <div className="flex items-center gap-2">
                   <img src={Kavachlogo} className="h-14 w-auto object-contain"/>
                </div>
            ...
            <div className="space-y-6">
                ...
                <ul className="space-y-3">
                    {["Features", "Pricing", "API", "Integrations"].map((item) => (
                        <li key={item}>
                            <Link to="#" className="text-slate-400 hover:text-orange-400 transition-colors text-sm flex items-center gap-2 group">
