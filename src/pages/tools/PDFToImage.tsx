...
import { Upload, FileImage, ArrowRightLeft, ArrowLeft, Check, X, FileText } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto space-y-8 px-4 sm:px-6 lg:px-8">
            ...
            {!file ? (
              ...
              <div className="space-y-8">
                ...
                <Card className="bg-white/80 backdrop-blur-md shadow-xl border border-slate-200 max-w-4xl mx-auto">
                  <CardHeader>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                  <Card className="bg-white/80 backdrop-blur-md shadow-xl border border-slate-200 relative">
                    <Button 
                      variant="ghost" 
                      size="icon"
                    ...
                    <CardContent>
                      <div className="w-full aspect-square bg-slate-100 rounded-xl flex items-center justify-center border border-slate-200">
                        <p className="text-slate-400">[PDF Preview Placeholder]</p>
                      </div>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                  <Card className="bg-white/80 backdrop-blur-md shadow-xl border border-slate-200">
                    <CardHeader>
                      <CardTitle className="text-slate-900">Conversion Options</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <RadioGroup value={conversionMode} onValueChange={(val) => setConversionMode(val as "page" | "extract")}>
                        ...
                        <Label htmlFor="page-to-jpg" className={cn(
                          "flex items-start gap-4 p-4 border rounded-xl cursor-pointer transition-colors bg-slate-50",
                          conversionMode === "page" ? "border-orange-500 bg-orange-50" : "border-slate-300 hover:border-slate-400"
                        )}>
                          <RadioGroupItem value="page" id="page-to-jpg" className="mt-1 border-slate-400 text-orange-600" />
                          <div className="flex-1 space-y-1">
                            <div className="flex justify-between items-center">
                              <span className="font-semibold text-slate-900">PAGE TO JPG</span>
                              {conversionMode === "page" && <Check className="h-5 w-5 text-orange-600" />}
                            </div>
                        ...
                        <Label htmlFor="extract-images" className={cn(
                          "flex items-start gap-4 p-4 border rounded-xl cursor-pointer transition-colors bg-slate-50",
                          conversionMode === "extract" ? "border-orange-500 bg-orange-50" : "border-slate-300 hover:border-slate-400"
                        )}>
                          <RadioGroupItem value="extract" id="extract-images" className="mt-1 border-slate-400 text-orange-600" />
                          <div className="flex-1 space-y-1">
                            <div className="flex justify-between items-center">
                              <span className="font-semibold text-slate-900">EXTRACT IMAGES</span>
                              {conversionMode === "extract" && <Check className="h-5 w-5 text-orange-600" />}
                            </div>
                            <p className="text-sm text-slate-500">
                      ...
                      <div className="space-y-3">
                        <Label className="font-semibold text-slate-900">Image quality</Label>
                        <RadioGroup 
                          value={imageQuality} 
                        ...
                        >
                          <div>
                            ...
                            <Label
                              htmlFor="normal"
                              className="flex flex-col items-center justify-between rounded-xl border-2 border-slate-300 bg-slate-50 p-4 hover:bg-slate-100 hover:text-slate-900 peer-data-[state=checked]:border-orange-500 peer-data-[state=checked]:text-orange-600 cursor-pointer transition-all text-slate-600"
                            >
                              Normal
